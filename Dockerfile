...
# Neovim & python setup
RUN apt-get update && apt-get install --assume-yes curl zsh neovim xsel

RUN pip3 install --upgrade pip && pip3 install neovim cython jedi pynvim flake8 isort black pyspark poetry
